...
switch ($_GET["op"]) {
    ...
    case 'actualizar': // Procedimiento para actualizar un producto existente
        ...
        $datos = array();
        $datos = $producto->actualizar($idProductos, $Codigo_Barras, $Nombre_Producto, $Graba_IVA, $Unidad_Medida_idUnidad_Medida, $Cantidad, $Valor_Compra, $Valor_Venta, $Proveedores_idProveedores, $IVA_idIVA);
        echo json_encode($datos);
        break;
